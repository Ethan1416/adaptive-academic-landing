      ...
      <div className="prose prose-lg max-w-none">
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            Adaptive Academic Learning Solutions ("we," "our," or "us") operates educational platforms including StartPatriot, StartCompTIA, StartIELTS, StartRealEstateLicense, StartTOEFL, StartNCLEX, and StartGRE. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our websites and use our services.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-4">
            We may collect personal information that you voluntarily provide when registering for an account, subscribing to our services, or contacting us. This includes:
          </p>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-gray-700 mb-4">
            ...
            <li>Analyze usage to improve our platforms</li>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-gray-700 mb-4">
            <li>Service providers who assist in operating our platforms</li>
